    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.status === 200 || response.status === 201) {
                ...
                await alertError(responseBody?.errors || 'Failed to create contact. Please try again.')
            }
        } catch (err) {
            console.error(err)
                    ...
                    <div className="p-8">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex justify-end space-x-4">
                                <a href="dashboard.html" className="px-5 py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-all duration-200 flex items-center shadow-md">
