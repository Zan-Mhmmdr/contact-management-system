...
import { addressDelete, addressesDelete, addressesList } from "../../lib/api/AddressesApi";
                                        ...
                                        <div key={address.id}>
                                            ...
                                            <div className="bg-gray-700 bg-opacity-50 p-5 rounded-lg shadow-md border border-gray-600 card-hover">
                                                ...
                                                <div className="flex justify-end space-x-3">
                                                    <Link to={`/dashboard/contacts/addresses/${address.id}/edit`} className="px-4 py-2 bg-gradient text-white rounded-lg hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-all duration-200 font-medium shadow-md flex items-center">
